(function(){
    ...
    function deleteOverflow()
    {
        ...
        for (i = 0; i < clone.length; i++){
            if (nodrop == true || clone[i].offsetLeft <= drop_zone.offsetLeft - 99 || clone[i].offsetLeft >= drop_width - 1 || clone[i].offsetTop <= drop_zone.offsetTop - 99 || clone[i].offsetTop >= drop_height - 1)
                clone[i].remove();
        }
        for (i = 0; i < clone.length; i++){
            if (nodrop == true || clone[i].offsetLeft <= drop_zone.offsetLeft - 99 || clone[i].offsetLeft >= drop_width - 1 || clone[i].offsetTop <= drop_zone.offsetTop - 99 || clone[i].offsetTop >= drop_height - 1)
